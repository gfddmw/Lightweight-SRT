...
from src.teacher_model.architecture.configs import Config
from src.teacher_model.architecture.pytorch_i3d import InceptionI3d

# from src.common.datasets.nslt_dataset import NSLT as Dataset
from src.common.datasets.nslt_dataset import NSLT as Dataset
...
if __name__ == '__main__':
    ...
    save_model = 'weights/teacher/'
    train_split = './data/WLASL2000/preprocess/nslt_2000.json'

    #weights = 'weights/teacher/archived/asl2000/FINAL_nslt_2000_iters=5104_top1=32.48_top5=57.31_top10=66.31.pt'
    weights = 'weights/teacher/nslt_2000_009108_0.443904.pt'
    config_file = 'configs/teacher/asl2000.ini'
