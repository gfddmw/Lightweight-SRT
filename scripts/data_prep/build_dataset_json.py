...
def main() -> None:
    ...
    parser.add_argument("--input_json", default="../../data/WLASL2000/preprocess/nslt_2000.json")
    parser.add_argument("--output_json", default="../../data/WLASL2000/preprocess/nslt_2000_train_filtered.json")
    parser.add_argument("--bad_ids_json", default="../../data/WLASL2000/preprocess/bad_samples.json")
