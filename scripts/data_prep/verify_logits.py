...
LOGITS_DIR = os.path.abspath(os.path.join(BASE_DIR, '../../processed/logits'))  # 你的 .npy 文件夹
JSON_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../data/WLASL2000/preprocess/nslt_2000.json'))  # 你的原始标签文件
